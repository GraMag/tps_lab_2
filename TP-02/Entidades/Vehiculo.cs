...
namespace Entidades
{
    ...
    public abstract class Vehiculo
    {
        ...
        /// <summary>
        /// Constructor que es solo accesible para las clases hijas
        /// </summary>
        /// <param name="chasis">Chasis del vehiculo</param>
        /// <param name="marca">Marca del vehiculo</param>
        /// <param name="color">Color del vahiculo</param>
        ...
        /// <summary>
        /// Sobreescribe el operador string con los datos del vehiculo
        /// </summary>
